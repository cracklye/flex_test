...
import 'package:flex_test/src/model/test_log.dart';
...
abstract class ATestPageState<P extends ATestPageWidget> extends State<P> {
  ...
  Widget buildTestScripts(
    ...
    return SizedBox(width: 300, child: Text("Need to implement log in the bloc")
        // ListView.builder(
  ...
  Widget doGenerate(
    ...
    return test.buildTestWidget!(
        ...
        parameters,
        (message) => addToLog(message, test, group),
        state.testEnvironment ?? DesignFramework.fluent);
  }
